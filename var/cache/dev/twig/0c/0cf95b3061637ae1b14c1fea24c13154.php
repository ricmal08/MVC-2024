...
class __TwigTemplate_59b9da752f12c995c8957ec84928908e extends Template
{
    private $source;
    private $macros = [];
...
<ul>
    <li>";
        // line 11
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["diceString"]) || array_key_exists("diceString", $context) ? $context["diceString"] : (function () { throw new RuntimeError('Variable "diceString" does not exist.', 11, $this->source); })()), "html", null, true);
        yield "</li>
</ul>
";
    ...
    {
        return array (  97 => 11,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "pig/test/roll.html.twig", "/home/ciderfabriken/dbwebb-kurser/mvc/me/report/templates/pig/test/roll.html.twig");
    }
}
