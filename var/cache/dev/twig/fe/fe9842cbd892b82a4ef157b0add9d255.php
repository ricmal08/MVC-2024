...
<p>The card drawn is: ";
        // line 7
        yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["card"]) || array_key_exists("card", $context) ? $context["card"] : (function () { throw new RuntimeError('Variable "card" does not exist.', 7, $this->source); })()), "getAsHtmlString", [], "method", false, false, false, 7);
        yield "</p>
<p>Remaining cards in deck: ";
        // line 8
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["remainingCards"]) || array_key_exists("remainingCards", $context) ? $context["remainingCards"] : (function () { throw new RuntimeError('Variable "remainingCards" does not exist.', 8, $this->source); })()), "html", null, true);
        yield "</p>
...
";
    ...
    {
        return array (  97 => 8,  93 => 7,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
<h1>Draw a card</h1>
<p>The card drawn is: {{ card.getAsHtmlString()|raw }}</p>
