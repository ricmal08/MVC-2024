...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/quote' => [[['_route' => 'api_quote', '_controller' => 'App\\Controller\\ControllerJson::apiQuote'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        198 => [[['_route' => 'card_deck_draw_count', 'number' => null, '_controller' => 'App\\Controller\\CardGameController::drawCount'], ['number'], ['GET' => 0], null, false, true, null]],
        234 => [[['_route' => 'api_deck_draw_number', 'number' => null, '_controller' => 'App\\Controller\\ControllerJson::drawMultipleCards'], ['number'], ['POST' => 0], null, false, true, null]],
        270 => [[['_route' => 'test_roll_num_dices', '_controller' => 'App\\Controller\\DiceGameController::testRollDices'], ['num'], null, null, false, true, null]],
        292 => [
